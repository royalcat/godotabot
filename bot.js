...
client.on('message', (message) => {
	...
	if(message.content == prefix + "help")
	{
		...
		message.channel.send("Go - префикс для всех комманд, далее его не будет**1.anime - кричит - Что поцаны Аниме? - в ваш голосовой чат**2.dota (цифра) - зовет всех в доту нужное количество раз, но не более 10**3.random coub - рандомный коуб**4.Уди - выгоняет бота из голосового чата"
		);
	}
});
